            ...
            <main className="grow pt-24 pb-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-12 text-center">
                        <h1 className="text-4xl md:text-5xl font-bold text-brand-border mb-4">
                            Khám Phá Đà Nẵng
                        </h1>
                        <div className="w-24 h-1 bg-brand-teal mx-auto mb-6 rounded-full"></div>
                        <p className="text-gray-600 max-w-2xl mx-auto text-lg">
                            Tổng hợp những địa điểm du lịch, ẩm thực và trải
                            nghiệm không thể bỏ qua khi đến với thành phố đáng
                            sống.
                        </p>
                    </div>
