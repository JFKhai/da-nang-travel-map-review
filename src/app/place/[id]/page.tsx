    ...
    <div className="flex flex-col min-h-screen bg-brand-bg font-sans">
      ...
      <main className="grow">
        ...
        <section className="relative h-[70vh] w-full overflow-hidden">
          <Image src={locationData.images[0]} alt={locationData.title} fill className="object-cover" priority />
          {/* Dark gradient overlay for text readability */}
          <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent" />

          <div className="absolute bottom-0 left-0 w-full p-8 md:p-16 text-white z-10">
            <div className="max-w-5xl mx-auto">
              <h1 className="text-4xl md:text-7xl font-bold mb-4 drop-shadow-2xl">{locationData.title}</h1>
        ...
        <section className="max-w-5xl mx-auto px-6 py-16">
          <div className="flex items-center justify-between mb-10 border-b border-gray-100 pb-6">
            <div className="flex items-center gap-3">
              <h2 className="text-3xl font-bold text-brand-border">Đánh giá cộng đồng</h2>
            ...
            {locationData.reviews?.map((review, index) => (
              ...
              >
                <div className="flex items-center gap-5 mb-6">
                  ...
                  <div className="grow">
                    <h4 className="font-bold text-brand-border text-lg group-hover:text-brand-teal transition-colors">
                      {review.name}
                    </h4>
