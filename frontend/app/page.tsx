...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#f7fce8] to-[#e9f4fb]">
      ...
      <header className="flex items-center justify-between px-10 py-4">
        ...
        <nav className="flex items-center gap-[52px] text-lg text-gray-700">
          ...
          <a className="rounded-xl bg-brand-light px-5 py-2 font-medium text-teal-900">Explore</a>
        </nav>
      </header>
      {/* Line decorate */}
      ...
      <section className="relative  px-10 py-4">
        <div className="grid grid-cols-2 gap-0 bg-[url('/images/map-bg-image.png')] bg-contain bg-center bg-no-repeat">
          ...
          <div className="">
            <div className="pr-3">
              <p className="mb-2 text-[18px] uppercase font-bold tracking-widest text-[#81949D]">Mountains | Plains | Beaches</p>
              <h2 className="mb-2 text-[64px] leading-tight text-brand-teal font-bold">Spend your vacation with our activities & places</h2>
              <p className="pr-3 text-[20px] text-[#81949D]">The traveller where you can select your desired activity and destinations of your choice for vacations.</p>
            </div>
              ...
              <div className="relative w-full overflow-hidden">
                <div className="flex gap-[32px] animate-marquee will-change-transform hover:[animation-play-state:paused]">
                  {[...items, ...items].map((item, i) => (
                    <div key={i} className={cn("w-[198px] overflow-hidden shrink-0 p-4", item.roundedContainer, item.bg)}>
    ...
    [-webkit-mask-position:center]"
            ...
            <img src="/images/circle-small.png" alt="" className="absolute z-10 -bottom-40 -right-40 animate-float-scale-delayed" />
          </div>
        </div>
        ...
        <div className="px-10 pt-10 pb-16 w-full">
          <div className="mx-auto flex max-w-5xl items-center gap-6 rounded-2xl bg-white p-6 shadow-lg">
            ...
            <div className="flex flex-1 flex-col gap-1">
              ...
              <input type="text" placeholder="Where are you going?" className="w-full text-sm outline-none placeholder:text-gray-400" />
            </div>
            ...
            <div className="flex flex-1 flex-col gap-1">
              ...
              <input type="text" placeholder="Choose activity" className="w-full text-sm outline-none placeholder:text-gray-400" />
            </div>
            ...
            <div className="flex flex-1 flex-col gap-1">
              ...
              <input type="number" placeholder="2" min={1} className="w-full text-sm outline-none placeholder:text-gray-400" />
            </div>

            {/* Search button */}
            <button className="ml-2 flex px-4 py-2 items-center justify-center rounded-2xl bg-brand-teal text-white hover:opacity-90">SEARCH</button>
          </div>
        </div>
