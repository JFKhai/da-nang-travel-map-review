        ...
        <div className="w-full lg:w-[20%] bg-white border-l border-gray-200" style={{ minWidth: '300px' }}>
          <div className="sticky top-0 h-screen overflow-y-auto">
            <div className="p-6 lg:p-8 space-y-6">
              <div>
                <h1 className="text-3xl lg:text-4xl font-bold mb-4 text-gray-800">{locationData.title}</h1>
              ...
              {locationData.description && (
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  <p className="text-base text-gray-600 leading-relaxed">{locationData.description}</p>
                </div>
              )}
